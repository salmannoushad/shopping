...
// include header file
include 'header.php'; ?>
<div class="admin-content-container" style="height: 80vh">
    <h2 class="text-center text-uppercase pt-5">Edit Product</h2>
    <?php
    $id = $_GET['id'];
    $db = new Database();
        ...
        foreach ($result as $row) { ?>
            <form id="updateProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-primary mt-2 text-uppercase" name="submit" value="Update">
                    </div>
                </div>
            </form>
    <?php
