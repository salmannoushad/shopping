...
// include header file
include 'header.php'; ?>
<div class="admin-content-container" style="height: 90vh">
    <h2 class="text-center text-uppercase pt-5">All SubCategory</h2>
    <a class="btn btn-primary pull-right" href="add_sub_category.php">Add New</a>
    <?php
    $limit = 10;
    $db = new Database();
