...
if (isset($_SESSION['user_id']) && $_SESSION['user_role'] == 'user') {
    ...
    <div class="container mt-3 mb-3">
        <div class="row">
            <div class="col-md-8 offset-md-2 bg-light border border-dark text-dark">

                <!-- Form -->
                <form id="register_sign_up" method="POST">
                    <h2 class=" text-center mb-2">Register Here</h2>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="mobile" class="form-control mobile" placeholder="Mobile" requried />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <input type="submit" name="signup" class="btn btn-primary my-3 text-capitalize " value="sign up" />
                    </div>
                </form>
                <!-- /Form -->
            </div>
